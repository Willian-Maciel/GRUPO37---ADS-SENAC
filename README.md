...
* **Visualizações e Métricas:** Gráficos de evolução temporal, comparação de volume total por método e KPIs de crescimento do PIX.

## 4. Ideia Inicial do Dashboard
O dashboard será focado em uma linha do tempo comparativa, permitindo visualizar o momento exato em que o PIX ultrapassou métodos como TED e Boleto em volume de transações.
